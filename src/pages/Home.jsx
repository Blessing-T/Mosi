...
const MosiOaTunyaWebsite = () => {
  ...
  return (
    <div className="ingonyama min-h-screen">
      ...
      <section className="relative bg-white overflow-hidden min-h-[500px]">
       <Navbar />
        <BouncingCircle size={96} color="bg-red-200" opacity="opacity-60" initial={{ x: 50, y: 50 }} />
        <BouncingCircle size={72} color="bg-red-300" opacity="opacity-40" initial={{ x: 200, y: 100 }} speed={2.5} />
        <BouncingCircle size={56} color="bg-red-400" opacity="opacity-30" initial={{ x: 300, y: 200 }} speed={2.2} />
        <BouncingCircle size={120} color="bg-red-200" opacity="opacity-50" initial={{ x: 400, y: 150 }} speed={2.8} />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 max-w-xl">
              ...
              <p className="text-3xl md:text-5xl font-bold text-red-900 mb-6 leading-tight">
                Welcome to<br />
                <span className="text-red-700">Mosi-Oa-Tunya</span><br />
                <span className="text-red-700">High School</span>
              </p>
              <p className="text-gray-700 text-base md:text-lg mb-8 leading-relaxed">
                We inspire excellence, foster growth, and celebrate achievements.
                Together, let's embark on a journey of learning and discovery!
              </p>
  ...
  {[
    {
      title: 'Portal',
      icon: (
        <svg className="mx-auto w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      title: 'Admission',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto w-8 h-8 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <path d="M2 17l10 6 10-6" fill="none" stroke="white" strokeWidth="2" />
        </svg>
      ),
    },
    {
    ...
    <div key={index} className="bg-red-800 rounded-lg p-6 md:p-8 text-center hover:shadow-lg transition-shadow flex flex-col items-center justify-center">
        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="flex-1 ">
              <div className="text-xs md:text-sm uppercase tracking-wide mb-2">2025 JUNE EXAMS</div>
              <h2 className="text-3xl md:text-5xl font-bold mb-6 md:mb-8">REGISTER NOW</h2>
              <div className="flex space-x-2 sm:space-x-4 md:space-x-8 mb-6 md:mb-8">
                {[
                  ...
                  >
                    <div>
                      <div className="text-lg sm:text-2xl md:text-4xl font-bold text-white">{time.value}</div>
                      <div className="text-xs sm:text-sm md:text-base uppercase text-white">{time.label}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            >
              <div className="bg-red-700 text-white p-3 md:p-4 rounded-lg mb-4 md:mb-6">
                ...
                <p className="text-xs md:text-sm">Please Fill in the Form and Submit to Enroll</p>
              </div>
              <div className="space-y-3 md:space-y-4">
                ...
                {submitted && (
                  <div className="text-green-600 text-sm mt-2">Form submitted successfully!</div>
                )}
              </div>
            </form>
          </div>
  ...
  {[
    ...
    <div
      ...
      style={{
        boxShadow: "0 4px 24px 0 rgba(0,0,0,0.10), 0 1.5px 6px 0 rgba(0,0,0,0.10)"
      }}
    >
      ...
      <h3 className="text-lg md:text-xl font-bold mb-2 md:mb-4 text-center group-hover:text-white transition-colors duration-300">{item.title}</h3>
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 md:pr-12">
              <h2 className="text-2xl md:text-4xl font-bold text-red-700 mb-6 md:mb-8">Welcome to Mosi</h2>
              <p className="text-gray-700 text-base md:text-lg leading-relaxed mb-6 md:mb-8">
                We are thrilled to welcome you to Mosi-Oa-Tunya High School, where excellence meets opportunity and dreams become reality. Our school is dedicated to fostering a nurturing environment that encourages academic achievement, personal growth, and lifelong learning. 
                At Mosi-Oa-Tunya High School, we believe that every student has their full potential. Our dedicated faculty and staff are committed to providing a well-rounded education that not only focuses on academic excellence but also emphasizes character development, critical thinking, and creativity. We strive to create a community of discovery, exploration, and achievement. Together, we will create lasting memories and build a strong foundation for a successful and fulfilling future.
              </p>
      ...
      <section className="py-10 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-xl md:text-3xl font-bold text-center mb-2 md:mb-4 text-red-700">News & Events</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 mb-6 md:mb-8">
            <div className="relative rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="absolute bottom-4 left-4">
                <span className="bg-red-700 text-white px-4 py-2 rounded-md">Lorem Ipsum</span>
              </div>
            </div>
            <div className="relative rounded-lg overflow-hidden shadow-lg">
              <img 
